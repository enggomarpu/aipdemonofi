        ...
        {Posts.map((result) => {
          return (
            <tr key={result.Post.PostId}>
                ...
                <div className="d-flex">
                  <div className="image-panel">
                    <img
                      className="card-img "
                      src={
                        result.Post.PostAttachments[0] &&
                        result.Post.PostAttachments[0].FileType.split("/")[0] ==
                          "image"
                          ? filePickerService.getImageLink(
                              result.Post.PostAttachments[0].FileHandler
                            )
                          : NoImg
                      }
                    />
              ...
              <td>
                {result.Post.IsApproved == true ? (
                  <span>Approved</span>
                ) : result.Post.IsApproved == false ? (
                  <span>Rejected</span>
                ) : (
                  <span>Pending</span>
                )}
              ...
              <td>
                <button
                  ...
                  onClick={(e) => ViewSinglePost(e, result.Post.PostId, false)}
                >
                  View
                </button>
              </td>
