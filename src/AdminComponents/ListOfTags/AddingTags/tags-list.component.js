                                ...
                                {tags && tags.map((tag) => {
                                    return (
                                        <tr >
                                            ...
                                            <td style={{ textAlign: "left" }}>{tag.TagName}</td>

                                            <td style={{ textAlign: "left" }}>{format(new Date(tag.CreatedDate), 'yyyy-MM-dd')}</td>
                                            <td style={{ textAlign: "left" }}>{tag.IsApproved ? "Approved" : "Pending"}</td>
                                            <td>
